        ...
        <div class="row">
          ...
          <p></p>
            ...
            <p></p>
						...
						<div class="form-group">
							<input type="text" placeholder="Votre prénom" class="form-control" name="prenom" id="prenom">
						</div>
            ...
            <div class="form-group">
            <input type="text" placeholder="Nombre de personne(s)" class="form-control" name="pers" id="pers">
          </div>
